...
console.log(string.fromCharCode('Teddy'.charCodeAt(2)))
...
console.log(ozgur.includes('saw'))
...
console.log(replaceGokuWithVegeta.replace('paku'))
...
console.log('   This is an example of trim   '.trim())
// =================================================
//                     BOOLEAN
// =================================================
...
for(let i= 0 ; i>=10 ; i++){console.log('The room has been soinning like crazy')}
// Harry said that was so mean of Teo to do Ken dirty like that. Make Teo's vision spin 20 times FOR LOOP.
for(let i= 0; i>=20 ; i++){console.log('That was so mean of Teo to do Ken dirty like that')}
// But wait! Lisa said, while Teo is spinning 20 times. Let's make him say "I'm sorry". Print I'm sorry 20 times using a WHILE loop.
let i= 0; while(i<=20){console.log("i'm sorry"); i++}
...
const lana = ['l', 'a', 'n', 'a']
for(ch in lana){console.log(ch)}
// USE (FOR OF LOOP)!
const tia = ['teo', 'the', 'syntax', 'of', 'this', 'is', 'cleaner']
for(item of tia){console.log(item)}
// Look into forEach() loop, it accepts a callback aka a function inside a function. 
// Swathi said don't forget each person. No person left behind! Use forEach() to iterate over the array perscholas. Inside the function, create a variable with the string "PS". Print their name in the console concatenated with the variable. 
const perscholas = ['Amira', 'Arely', 'Jonathan']
perscholas.forEach(item => console.log('PS: ${item'))
// =================================================
//                     ARRAYS
// =================================================
let participants = ["Arely", "Ozgur", "Swathi", "Touseef"]
console.log(participants)
// Look up the following: Make a note of what each one of these methods do
// push()
participants.push("Teo")
console.log("After push method" + participants)
// pop()
participants.pop()
console.log("After pop method" + participants)
// unshift()
participants.unshift("Teo")
console.log("After unshift method" + participants)
// shift()
participants.shift()
console.log("After shift method" + participants)
// concat()
let instructors = ["Teo","Joshua"]
console.log(participants.concat(instructors))
// splice()
participants.splice(1,0, "New student")
console.log(participants)
// slice()
console.log("This is a slice form -2", participants.slice(-2))
// sort()
console.log("This is a sort", participants.sort())
// includes()
console.log("This includes Ozgur", participants.includes("Ozgur"))
// indexOf()
console.log("what is the index of Swathi", participants.indexOf('Swathi'))
// length
console.log("Lenght of participant array is ", participants.length)
...
const exoticFruits = ['durian', 'lucana','sapodilla']
...
console.log(RafaelNoBadWords.split(' ').filter(word => !word.includes('badword')).join(" "))
...
console.log(numbersToAddUp.reduce((x,y) => x+y))

// ===== SPREAD OPERATOR ===== 

// Create a variable and assign a value of a copied array using the spread operator
const arrOne = ["hello", "goodbye"]
const arrTwo = [...arrOne ]
// Create two arrays with any elements and connect both of them using the spread operator. Save the connected arrays into a new variable.
const daysOne =["saturday", "sunday"]
const daysTwo =["monday", "tuesday"]
const allDays =[...daysOne, ...daysTwo]
console.log(allDays)
...
let bulbasaurTwo = bulbasaur["name"]["abilities"]["moves"]
console.log(bulbasaurTwo)
